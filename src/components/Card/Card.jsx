    ...
    return (
        <div className="rounded-md space-y-4 h-[250px]">
            <div className="relative h-full w-full group overflow-hidden rounded-md">
                <img src={image == "" || image == undefined || image == null ? `/default.jpg` : image} className="h-full w-full group-hover:scale-105 duration-1000 rounded-md object-cover absolute" alt="" />
